...
Usage:
    python scripts/export_reaction_rates_simple.py
"""
...
from scripts.envelope_visuals import ODOR_ORDER
...
if __name__ == "__main__":
    # Configuration
    wide_csv = Path("/home/ramanlab/Documents/cole/Data/Opto/Combined/all_envelope_rows_wide.csv")
