...
Usage:
    python scripts/collect_to_label_images.py
    python scripts/collect_to_label_images.py --dry-run  # preview only
"""
...
def collect_to_label_images(
    ...
    Args:
        source_root: Root directory to search (e.g., /securedstorage/DATAsec/cole/Data-secured)
...
def main():
    ...
    parser.add_argument(
        "--source-root",
        type=Path,
        default=Path("/securedstorage/DATAsec/cole/Data-secured"),
        help="Root directory to search for to_label folders (default: Data-secured)",
    )
    parser.add_argument(
        "--dest",
        type=Path,
        default=Path("/home/ramanlab/Documents/cole/model/to-be-labelled"),
        help="Destination directory for collected images",
    )
    parser.add_argument(
        "--dry-run",
        action="store_true",
