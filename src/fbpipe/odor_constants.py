...
ODOR_CANON: Mapping[str, str] = {
    ...
    "hex-training-24-0.01": "Hex-Training-24-0.01",
    "hex_training_24_0.01": "Hex-Training-24-0.01",
    "hex training 24 0.01": "Hex-Training-24-0.01",
    "hex-training-24-0.1": "Hex-Training-24-0.1",
    "hex_training_24_0.1": "Hex-Training-24-0.1",
    "hex training 24 0.1": "Hex-Training-24-0.1",
    "hex training 24": "Hex-Training-24",
    "hex training 36": "Hex-Training-36",
    ...
    "hex control 24 0.005": "Hex-Control-24-0.005",
    "hex-control-24-0.01": "Hex-Control-24-0.01",
    "hex_control_24_0.01": "Hex-Control-24-0.01",
    "hex control 24 0.01": "Hex-Control-24-0.01",
    "hex-control-24-0.1": "Hex-Control-24-0.1",
    "hex_control_24_0.1": "Hex-Control-24-0.1",
    "hex control 24 0.1": "Hex-Control-24-0.1",
...
DISPLAY_LABEL: dict[str, str] = {
    ...
    "Hex-Control-24-0.01": "Hexanol",
    "Hex-Control-24-0.1": "Hexanol",
    ...
    "Hex-Training-24-0.01": "Hexanol",
    "Hex-Training-24-0.1": "Hexanol",
    "AIR-Training": "AIR",
    "3OCT-Training": "3-Octanol",
    "3OCT-Training-24-2": "3-Octanol",
    "Cit-Training": "Citral",
    "Cit-Control": "Citral",
...
TESTING_DATASET_ALIAS: dict[str, str] = {
    ...
    "Hex-Control-24-0.01": "Hex-Control",
    "Hex-Training-24-0.01": "Hex-Control",
    "Hex-Control-24-0.1": "Hex-Control",
    "Hex-Training-24-0.1": "Hex-Control",
